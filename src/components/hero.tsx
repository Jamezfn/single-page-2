...
type Prop = PropsWithChildren<{ size: number; rotation: number; orbitDuration?: string; shouldOrbit?: boolean; shouldSpin?: boolean; spinDuration?: string;  }>;

export default function HeroOrbit({ children, size, rotation, orbitDuration, shouldOrbit=false, shouldSpin, spinDuration }: Prop) {
  return (

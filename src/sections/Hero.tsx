...
import HeroOrbit from '@/components/hero';
	...
	return (
		<div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
			<div className='absolute inset-0 mask-[linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]'>
				...
				<HeroOrbit size={530} rotation={90} shouldOrbit orbitDuration='36s' shouldSpin spinDuration="3s">
			...
			<div className="container">
				...
				<div className='max-w-lg mx-auto'>
					...
					<p className='mt-4 text-center text-foreground/60 md:text-lg'>I specialize in transforming designs into functional, high-performing web applications. Let's discuss your next project.</p>
				</div>
				<div className='flex flex-col md:flex-row items-center justify-center mt-8 gap-4'>
					<button className='inline-flex items-center gap-2 border border-foreground/15 px-6 h-12 rounded-xl '>
						<span className='font-semibold'>Explore My Work</span>
						<FontAwesomeIcon icon={faArrowDown} className='size-4' />
					</button>
					<button className='inline-flex items-center gap-2 border border-foreground bg-foreground text-gray-900 h-12 px-6 rounded-xl'>
						<span className=''>👋</span>
